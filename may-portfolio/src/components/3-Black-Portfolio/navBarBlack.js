...
const Header = () => { 
  ...
  return (
    <nav className="w-full text-gray-900 font-inter fixed top-0 z-50 ">
      <div className="mt-8 flex justify-between items-center ml-32">
        ...
        <div className="hidden flex flex-row mr-2 lg:flex font-bold mr-28 py-4 px-3 border-2 border-[#FF9A00] bg-white rounded-xl">
