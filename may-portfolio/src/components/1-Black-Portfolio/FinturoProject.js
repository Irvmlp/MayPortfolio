...
import Mockup1 from '/Users/irvinglamadrid/MayPortfolio/may-portfolio/src/components/1-Black-Portfolio/gallery/FInturo1.png';
import Mockup2 from '/Users/irvinglamadrid/MayPortfolio/may-portfolio/src/components/1-Black-Portfolio/gallery/Finturo1a.png';
  ...
  <section className='flex flex-col md:flex-row py-8 mt-12 bg-white rounded-xl border-2 botder-white h-full w-full mx-auto'>
    <div className='flex  w-full md:w-3/5 h-1/2 md:h-full  flex-col'>
        <div className='px-8 flex text-4xl w-full'>
            <h2 className='px-8 GtRegularBold text-[#75B570]'>Startup: Finturo</h2>
        </div>
    ...
    <div className='flex w-full md:w-2/5 h-1/2 md:h-full flex-col'>
        <div className='flex px-8 text-4xl w-full justify-end'>
            <h2 className='GtRegularBold px-8 text-[#75B570]'>Team-5 | 2024</h2>
        </div>
     ...
     <section className='mt-12 border-2 rounded-xl border-white bg-white items-center justify-center flex min-h-[450px] w-full'>
        <div className='w-full h-full flex justify-center flex-row py-8'>
         <img src={Mockup1} loading='lazy' className="w-1/5 h-auto" />
         <img src={Mockup2} loading='lazy' className="w-1/5 h-auto" />
        </div>
     </section>
     {/* 1. Story */}
     <section className='flex flex-col md:flex-row py-8 mt-12 bg-white rounded-xl border-2 botder-white h-full w-full mx-auto'>
    <div className='flex  w-full md:w-1/2 h-1/2 md:h-full  flex-col'>
        <div className='px-8 flex text-4xl w-full'>
            <h2 className='px-8 GtRegularBold text-[#75B570]'>The Story</h2>
        </div>
        <div className='flex h-24 items-center text-black text-lg '>
            <p className='GtRegular flex flex-row px-8 mt-2 md:px-16'>My cofounder Vlad and I decided to start Finturo as a way to reach a greater community of those around us. Growing we were always the ones asked advice on finances. </p>
        </div>
    </div>  
    <div className='flex  w-full md:w-1/2 h-1/2 md:h-full  flex-col'>
    <div className='px-8 flex justify-end text-4xl w-full'>
    <h2 className='px-8 GtRegularBold text-[#75B570]'>The Outcome</h2>
</div>
<div className='flex h-24 justify-end items-center text-black text-lg'>
    <p className='GtRegular justify-end text-right flex flex-row px-8 mt-2 md:px-16'> Our vision was becoming a plaform around CA and AZ that supported people from our community to secure financial freedom. In one summer this group grew from 12 to 58 people. </p>
</div>
    </div>  
</section>
 {/* 2. Product */}
